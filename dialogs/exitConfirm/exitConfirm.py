from utils.intents import ExitIntens, YesIntents
from .config import *
...
def isTriggered(event):
    return (isInContext(event, "exitConfirm") and isInCommandOr(event, YesIntents)) or isInCommandOr(event, ExitIntens)
