...
ttss = ["Вы уверены в том, что хотите выйти? Скажите Да, если хотите выйти из навыка. Скажите Нет, чтобы отменить выход из навыка.", "Вы точно хотите выйти?", "Вы подтверждаете свой выход? Скажите Да, если хотите выйти из навыка. Скажите Нет, чтобы отменить выход из навыка.",
        "Вы намерены выйти? Скажите Да, если хотите выйти из навыка. Скажите Нет, чтобы отменить выход из навыка.", "Подтверждаете ли вы свое решение о выходе из нашего навыка? Скажите Да, если хотите выйти из навыка. Скажите Нет, чтобы отменить выход из навыка.", ]
...
config = {
    ...
    "card": {
        ...
        "description":
            """
            Вы уверены в том, что хотите выйти? Варианты ответа: Да, Нет.
            """,
    },
}
