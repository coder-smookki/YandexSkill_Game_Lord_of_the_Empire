def getConfig(event):
    config = {
        ...
        "card": {
            ...
            ㅤㅤㅤㅤㅤㅤㅤㅤПлюснин Александр - Главный Разработчик (отвечает за всю оболочку навыка), 
            Кунакбаев Радмир - Разработчик и Сценарист (дополняет функционал и придумывает весь сценарий игры), 
            ㅤㅤㅤㅤㅤЛесовой Кирилл - Разработчик и Тестировщик (обеспечивает навык полным функционалом игры и фиксирует ошибки), 
