ThirdExtension = """
    ...
    true:
        ...
        true:
            ...
            true:
                "Кондрат $ Владыка, Хрисанф в ходе опыта создал зомби-вирус, который распространяется! // Чтo... // Как... // 0 0 0 0 $ 0 0 0 0 // None"
                true:
            ...
            false:
                "{FourthExtension}"
        false:
            "Кондрат $ Люди бунтуют, болезнь оказалась очень опасной, они недовольны тем, что мы никак не реагируем. // Командир! // Окажите помoщь всем нуждающимся! // 0 +100 -100 0 $ 0 0 0 0 // None"
            true:
