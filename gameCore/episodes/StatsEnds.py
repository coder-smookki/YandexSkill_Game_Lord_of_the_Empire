...
ZeroPercentArmy = """
    "Кондрат $ Разведчики соседних государств разузнали, то что наша армия находится в плачевном состоянии, вот-вот они начнут военные действия // Что... // Как... //  // None"
    true:
...
ZeroPercentNation = """ 
    "Кондрат $ Владыка! Народу не нравится ваша власть, он хочет уничтожить вас и вашу власть. // Что... // Как... //  // None"
    true:
...
ZeroPercentFinance = """
    "Кондрат $ Повелитель, экономика страны была полностью разрушена, наша защита больше не может сдерживать протесты жителей. // Что... // Как... //  // None"
    true:
