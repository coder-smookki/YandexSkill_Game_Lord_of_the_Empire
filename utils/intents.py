...
YesIntents = ['да ', re.compile('да$'), 'ок', 'конечно', 'соглас', 'окей', 'поехали', 'лес гоу', 'вперёд', 'вперед',
              'норм', 'ага', 'угу',
...
RepeatIntents = ['повтори', re.compile('что$'), re.compile('че$'), re.compile('чё$'), 'ещё раз', 'еще раз', 'репит',
                 'повтор', 'не пон', 'не догнал',
                 'не вкурил', 'ало', 'ась', 'але', 'алё', 'не расслыш', 'не услыш']
HelpIntents = ['помог', 'помощь', 'хелп', 'подмога', 'поддержка', 'не умею', 'не знаю', 'как ', 'расскаж', 'помочь']
...
LetsPlayIntents = ['игра', 'начать', 'сыграть', 'гоу', 'вперед', 'вперёд', 'погнали', 'пойдем', 'начнем', 'начнём',
                   'старт']
...
HowToUseIntents = ['использовать', 'применять', 'эксплуатировать', 'пользоваться', 'употреблять',
                   'распоряжаться', 'юзать', 'использовать', 'польз', 'как играть', 'научи', 'правила']
ExitIntents = ['выход', 'выйди', 'покинуть', 'выйти', 'слинять', 'законч']
